...
use WPOOP\API\Callbacks\CptCallbacks;
...
class CustomPostTypeController extends BaseController {
	...
	public function register() {
		if ( ! $this->activate_key( 'cpt_manager' ) ) {
			return;
		}
	...
	public function store_custom_post_type() {
		$options = get_option( 'wpoop_plugin_cpt' );
	...
	public function set_subpages() {
		$this->subpages = array(
			array(
				...
				'menu_slug'   => 'wpoop_cpt',
				'callback'    => array( $this->callbacks, 'cta_manager' ),
			),
		);
	}
